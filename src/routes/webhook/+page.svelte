...
<svelte:head>
	<title>LawCast - 디스코드 웹훅 등록 | 국회 입법예고 스냅샷 아카이브</title>
	<meta
		name="description"
		content="LawCast 디스코드 웹훅 등록 페이지. 국회 입법예고 변동사항을 디스코드 등으로 실시간 받아보려면 웹훅을 등록하세요."
	/>
	<meta
		name="keywords"
		content="LawCast, 입법예고, 디스코드 웹훅, 알림, 국회 법률안, 법안 모니터링, 입법예고 알림"
	/>
	<meta property="og:type" content="website" />
	<meta
		property="og:title"
		content="LawCast - 디스코드 웹훅 등록 | 국회 입법예고 스냅샷 아카이브"
	/>
	<meta
