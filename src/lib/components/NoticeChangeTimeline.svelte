								...
								<div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
									<div class="min-w-0 space-y-1.5">
										<div class="flex flex-wrap items-center gap-2">
											<div
												class="h-5 w-16 animate-pulse rounded-full bg-black/5 dark:bg-white/10"
											></div>
											<div
												class="h-5 w-20 animate-pulse rounded-full bg-black/5 dark:bg-white/10"
											></div>
										</div>
										<div class="flex flex-wrap items-center gap-1.5">
											<div class="h-3 w-24 animate-pulse rounded bg-black/5 dark:bg-white/10"></div>
											<div class="h-3 w-3 animate-pulse rounded bg-black/5 dark:bg-white/10"></div>
											<div class="h-3 w-28 animate-pulse rounded bg-black/5 dark:bg-white/10"></div>
											<div class="h-3 w-3 animate-pulse rounded bg-black/5 dark:bg-white/10"></div>
											<div class="h-3 w-16 animate-pulse rounded bg-black/5 dark:bg-white/10"></div>
											<div class="h-3 w-20 animate-pulse rounded bg-black/5 dark:bg-white/10"></div>
										</div>
									</div>
									<div
										class="h-3 w-20 animate-pulse rounded bg-black/5 dark:bg-white/10 sm:mt-1"
									></div>
								</div>
							</div>
						</div>
					...
					<div class="flex-1">
						...
						{#if onRetry}
							<button
								type="button"
								on:click={onRetry}
								class="lc-link mt-2 inline-block text-sm font-semibold"
							>
								다시 시도
							</button>
						{/if}
