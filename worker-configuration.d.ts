/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 63a0fc44765c9017e76d9df6859c1d83)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	API_BASE_URL: string;
	PUBLIC_HASHGUARD_URL: string;
	PUBLIC_DISCORD_SERVER_URL: string;
	PUBLIC_DISCORD_SERVER_ID: string;
	PUBLIC_CF_UNDER_ATTACK_RELOAD_ENABLED: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_URL" | "PUBLIC_HASHGUARD_URL" | "PUBLIC_DISCORD_SERVER_URL" | "PUBLIC_DISCORD_SERVER_ID" | "PUBLIC_CF_UNDER_ATTACK_RELOAD_ENABLED">> {}
}
