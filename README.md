...
- 메인 페이지(`recent notices`)에는 요약을 노출하지 않고, 목록 브라우징 성능/가독성을 우선합니다.
- 전체 입법예고 페이지에서만 AI 요약을 강조 카드로 노출합니다.
- 상세 페이지에서 AI 요약과 원문을 함께 제공하여 사용자 검증을 유도합니다.
...
- `/notices` : AI 브리핑 카드 포함 전체 입법예고 목록
